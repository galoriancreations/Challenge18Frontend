...
export const commitmentTexts = {
    ...
    "Hebrew": "אני, __, מתחייב להוביל את עצמי דרך אתגר של 18 ימים של קיימות ומנהיגות ומתחייב לשינוי אמיתי.  אני מתחייב להעז לפרוץ את אופקי החיים ולהצליח להתעלות מעל הישויות הפרטיות שלי ומעל נסיבות החיים."
};
