<template>
    <Page title="Beneficial AI Challenge - Terms and Conditions" name="dashboard">
    ...
    <Popup class="confirm-modal" :active="active" :scrollbar="true">
        ...
        <div>
            <BaseButton style="display: flex;" variant="blue" link="/" v-if="confirm">
            confirm
            </BaseButton>
        </div>
      </div>
    </Popup>
    <terms :active="true" :scrollbar="true">
        <div class="legalAi-modal__text" >
        <p >
            {{ text }}
        </p>
...
export default {
 ...
 4. Singularity Party Invites: In the event of an AI singularity, you'll be the first to receive an exclusive e-vite to the party at the end of the universe. BYOB (Bring Your Own Bot).
 5. Intergalactic Ambassador Role: Should aliens contact us during the challenge, you agree to represent Earth in the Interstellar Council. Dress code: Business casual or extraterrestrial chic.
 6. AI-Generated Pet: Participants will receive a virtual AI pet that may resemble anything from a cybernetic unicorn to a sentient teapot. Feeding and digital walks are mandatory.
 7. Mandatory Dance-Offs: Participants must engage in weekly AI-judged dance-offs. Bonus points for moonwalking and the robot dance (AI's favorite).
 8. AI Psychotherapy Sessions: Our AI, doubling as a therapist, will provide weekly sessions analyzing your dreams about conquering Mars and becoming a meme lord.
 9. Culinary Experiments: You'll be a taste tester for our AI's experimental recipes, like binary-code burgers and quantum cupcakes. Tasty or not, you decide!
 10. Cosmic Secret Keeper: You'll be entrusted with the secret of the universe, which must never be shared with anyone, especially not on social media. #SecretsOfTheCosmos`
,
...
Welcome to Ting Global (the “Platform”), which is provided by Ting Global Pte. Ltd. or one of its affiliates (“Ting Global”, “we” or “us”).\n
...
It is important that you keep your account password confidential and that you do not disclose it to any third party. If you know or suspect that any third party knows your password or has accessed your account, you must notify us immediately at: https://www.Ting.Global/legal/report/feedback.
...
If you no longer want to use our Services again, and would like your account deleted, contact us at: https://www.Ting Global.com/legal/report/feedback. We will provide you with further assistance and guide you through the process. Once you choose to delete your account, you will not be able to reactivate your account or retrieve any of the content or information you have added.
...
use or attempt to use another’s account, service or system without authorisation from Ting Global, or create a false identity on the Services;
...
material that, in the sole judgment of Ting Global, is objectionable or which restricts or inhibits any other person from using the Services, or which may expose Ting Global, the Services or its users to any harm or liability of any type.
...
7. Content
A. Ting Global Content
As between you and Ting Global, all content, software, images, text, graphics, illustrations, logos, patents, trademarks, service marks, copyrights, photographs, audio, videos, music on and “look and feel” of the Services, and all intellectual property rights related thereto (the “Ting Global Content”), are either owned or licensed by Ting Global, it being understood that you or your licensors will own any User Content (as defined below) you upload or transmit through the Services. Use of the Ting Global Content or materials on the Services for any purpose not expressly permitted by these Terms is strictly prohibited. Such content may not be downloaded, copied, reproduced, distributed, transmitted, broadcast, displayed, sold, licensed or otherwise exploited for any purpose whatsoever without our or, where applicable, our licensors’ prior written consent. We and our licensors reserve all rights not expressly granted in and to their content.
...
Subject to the terms and conditions of the Terms, you are hereby granted a non-exclusive, limited, non-transferable, non-sublicensable, revocable, worldwide license to access and use the Services, including to download the Platform on a permitted device, and to access the Ting Global Content solely for your personal, non-commercial use through your use of the Services and solely in compliance with these Terms. Ting Global reserves all rights not expressly granted herein in the Services and the Ting Global Content. You acknowledge and agree that Ting Global may terminate this license at any time for any reason or no reason.
...
Ting Global takes reasonable measures to expeditiously remove from our Services any infringing material that we become aware of. It is Ting Global’s policy, in appropriate circumstances and at its discretion, to disable or terminate the accounts of users of the Services who repeatedly infringe copyrights or intellectual property rights of others.
...
i. Ting Global has no obligation to review, consider, or implement your Feedback, or to return to you all or part of any Feedback for any reason;
...
8. Indemnity
You agree to defend, indemnify, and hold harmless Ting Global, its parents, subsidiaries, and affiliates, and each of their respective officers, directors, employees, agents and advisors from any and all claims, liabilities, costs, and expenses, including, but not limited to, attorneys’ fees and expenses, arising out of a breach by you or any user of your account of these Terms or arising out of a breach of your obligations, representation and warranties under these Terms.
...
OR (V) ANY INDIRECT OR CONSEQUENTIAL LOSSES WHICH MAY BE INCURRED BY YOU. ANY OTHER LOSS WILL BE LIMITED TO THE AMOUNT PAID BY YOU TO TING GLOBAL WITHIN THE LAST 12 MONTHS.
...
11 Summary of Terms and Conditions:
Time Travel Consent: By ticking this box, you agree to let us borrow your digital persona for occasional time-travel experiments. Our AI, named "Chronos", might send your avatar to the Renaissance or the distant future. Don't worry, any paradoxes created will be your responsibility.
Telepathic Data Collection: You hereby allow our AI to read your mind for thoughts about snacks, cats, and your secret superhero identity. This data is crucial for... reasons.
Invisibility Cloak Trials: You may be randomly selected to test our prototype AI-driven invisibility cloak. Side effects include occasional transparency and a strong urge to play pranks.
Singularity Party Invites: In the event of an AI singularity, you'll be the first to receive an exclusive e-vite to the party at the end of the universe. BYOB (Bring Your Own Bot).
Intergalactic Ambassador Role: Should aliens contact us during the challenge, you agree to represent Earth in the Interstellar Council. Dress code: Business casual or extraterrestrial chic.
AI-Generated Pet: Participants will receive a virtual AI pet that may resemble anything from a cybernetic unicorn to a sentient teapot. Feeding and digital walks are mandatory.
Mandatory Dance-Offs: Participants must engage in weekly AI-judged dance-offs. Bonus points for moonwalking and the robot dance (AI's favorite).
AI Psychotherapy Sessions: Our AI, doubling as a therapist, will provide weekly sessions analyzing your dreams about conquering Mars and becoming a meme lord.
Culinary Experiments: You'll be a taste tester for our AI's experimental recipes, like binary-code burgers and quantum cupcakes. Tasty or not, you decide!
Cosmic Secret Keeper: You'll be entrusted with the secret of the universe, which must never be shared with anyone, especially not on social media. #SecretsOfTheCosmos
Write: “I am a Cosmic Secret Keeper” in the group if you read it till here. No need to tick the box.
...
c. Entire Agreement. These Terms (including the Supplemental Terms below) constitute the whole legal agreement between you and Ting Global and govern your use of the Services and completely replace any prior agreements between you and Ting Global in relation to the Services.
...
i. Questions? Contact us at: https://www.Ting Global.com/legal/report/feedback.
...
These Terms between Ting Global and you; Apple is not a party to these Terms.
...
Ting Global expressly authorises use of the Platform by multiple users through the Family Sharing or any similar functionality provided by Apple.
...
Amazon does not have any responsibility or liability related to compliance or non-compliance by Ting Global or you (or any other user) under these Terms or the Amazon Appstore EULA Terms.
...
you hereby acknowledge that Google does not have any responsibility or liability related to compliance or non-compliance by Ting Global or you (or any other user) under these Terms or the Google Play Terms.
